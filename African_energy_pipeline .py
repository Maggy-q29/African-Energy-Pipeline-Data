 ...
 "cells": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "✅ Inserted 54 documents into MongoDB.\n"
     ]
    }
   ],
   "source": [
    ...
    "\n",
    "# 2: Reformat it to the required schema\n",
    "columns = [\"country\", \"country_serial\", \"metric\", \"unit\", \"sector\", \n",
    "           \"sub_sector\", \"sub_sub_sector\", \"source_link\", \"source\"] + \\\n",
    "          [str(year) for year in range(2000, 2025)]\n",
    "\n",
    "formatted_df = df.reindex(columns=columns)\n",
    "\n",
    "# 3: Connect to MongoDB\n",
    "client = MongoClient(\"mongodb+srv://quetsekhomargaret_db_user:Quesy30@cluster0.n7tv8lm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0\")\n",
    "db = client[\"energydb\"]\n",
    "collection = db[\"energy_indicators\"]\n",
    "\n",
    "# 4: Insert into MongoDB\n",
    "documents = formatted_df.to_dict(\"records\")\n",
    "\n",
    "if documents:\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "        return\n",
    "\n",
    "    mongo_uri = \"mongodb+srv://name_db_user:<password>@cluster0.n7tv8lm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0\"\n",
    "\n",
    "    try:\n",
